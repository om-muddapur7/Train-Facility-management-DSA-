...
// Return Type: NULL
void display(TrainNode* head,TrainNode* train_array[],int n) 
{
    int i;
    if (head == NULL) 
    {
...
// Function:    Partition
// Description: Partitions the array of trains based on train names for quicksort
...
// Input param: array of trains, array range(start and end)
// Return Type: NULL
void QuickSort(TrainNode* arr[], int l, int r) 
{
    if (l < r) 
    {
