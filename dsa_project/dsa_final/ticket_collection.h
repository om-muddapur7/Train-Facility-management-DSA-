#ifndef TICKET_COLLECTION_H_INCLUDED
#define TICKET_COLLECTION_H_INCLUDED
...
// Return type:     NULL
void read_element(int **input, int *n)
{
...
#endif // TICKET_COLLECTION_H_INCLUDED
