#ifndef EFFICIENT_SPEAKERS_H_INCLUDED
#define EFFICIENT_SPEAKERS_H_INCLUDED
...
// Return Type: index or -1
int train_search(char *train, TRAIN *trains, int size)
{
    int i;
...
void announce(TRAIN *trains, int size)
{
    ...
    int index = train_search(train, trains, size);
...
// Function:        load_from_file_train
// Description:     reads file
// Input parameter: NULL
// Return type:     NULL
void load_from_file_train(TRAIN *trains, int size)
{
    FILE *fp;
...
int speaker_announce()
{
    TRAIN trains[24];

    load_from_file_train(trains, 24);
...
#endif // EFFICIENT_SPEAKERS_H_INCLUDED
